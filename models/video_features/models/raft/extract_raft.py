...
import omegaconf
from models.video_features.models._base.base_flow_extractor import BaseOpticalFlowExtractor

from configs.paths import project_path

# defined as a constant here, because i3d imports it
DATASET_to_RAFT_CKPT_PATHS = {
    'sintel': f'{project_path}/models/video_features/models/raft/checkpoints/raft-sintel.pth',
    'kitti':  f'{project_path}/models/video_features/models/raft/checkpoints/raft-kitti.pth',
}
