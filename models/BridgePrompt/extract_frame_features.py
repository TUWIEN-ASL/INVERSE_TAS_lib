...
from datasets import Breakfast_FRAMES, GTEA_FRAMES, SALADS_FRAMES, SegDataset_FRAMES
...
def main():
    ...
    if args.dataset == 'breakfast':
        ...
        # Read paths from config if present; fall back to ImPerfectPour defaults.
        _cfg_data = config.data
        _root      = getattr(_cfg_data, 'root',      '/home/dsliwowski/Projects/Code_Inverse/catkin/src/inverse_tas/data/ImPerfectPour')
        _frame_dir = getattr(_cfg_data, 'frame_dir', '/home/dsliwowski/Projects/Code_Inverse/catkin/src/inverse_tas/data/ImPerfectPour/frames')
        _label_dir = getattr(_cfg_data, 'label_dir', '/home/dsliwowski/Projects/Code_Inverse/catkin/src/inverse_tas/data/ImPerfectPour/annotations')
        _class_dir = getattr(_cfg_data, 'class_dir', '/home/dsliwowski/Projects/Code_Inverse/catkin/src/inverse_tas/data/ImPerfectPour/mapping.json')
        val_data = SegDataset_FRAMES(root=_root,
