...
from datasets import Breakfast, GTEA, SALADS, SegDataset
...
def main():
    ...
    if args.dataset == 'breakfast':
        ...
        _root      = getattr(_cfg_data, 'root',      '/home/dsliwowski/Projects/Code_Inverse/catkin/src/inverse_tas/data/JIGSAW')
        _frame_dir = getattr(_cfg_data, 'frame_dir', '/home/dsliwowski/Projects/Code_Inverse/catkin/src/inverse_tas/data/JIGSAW/frames')
        _label_dir = getattr(_cfg_data, 'label_dir', '/home/dsliwowski/Projects/Code_Inverse/catkin/src/inverse_tas/data/JIGSAW/annotations')
        _class_dir = getattr(_cfg_data, 'class_dir', '/home/dsliwowski/Projects/Code_Inverse/catkin/src/inverse_tas/data/JIGSAW/mapping.json')
        train_data = SegDataset(root=_root,
                                frame_dir=_frame_dir,
                                label_dir=_label_dir,
                                class_dir=_class_dir,
                                transform=transform_train, mode='train', num_frames=config.data.num_frames,
                                n_split=config.data.n_split)
