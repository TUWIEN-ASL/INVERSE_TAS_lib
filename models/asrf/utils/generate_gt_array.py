...
def main() -> None:
    ...
    for dataset in datasets:
        ...
        gt_dir = os.path.join(args.dataset_dir, dataset, "annotations")
        gt_paths = glob.glob(os.path.join(gt_dir, "*.txt"))

        for gt_path in gt_paths:
            if "success" in gt_path or "hand" in gt_path or "capture_node" in gt_path:
                continue
            ...
            # save array
            np.save(os.path.join(save_dir, gt_name + ".npy"), gt_array)
